...
function onOpen() {
  ...
  ui.createMenu('Google Fit')
      ...
      .addItem('Get Metrics for past 5 years', 'getHistory')
...
function getHistory() {
  ...
  getMetricsForDays(start, end, 'Metrics');
    start = start - 60;
    end = end - 60;
  }
...
function getFitService() {
  ...
  return OAuth2.createService('fit')
      ...
      .setScope('https://www.googleapis.com/auth/fitness.activity.read https://www.googleapis.com/auth/fitness.body.read https://www.googleapis.com/auth/fitness.location.read https://www.googleapis.com/auth/fitness.heart_rate.read https://www.googleapis.com/auth/fitness.sleep.read')
